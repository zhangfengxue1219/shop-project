      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(prop, index) in options.props" :key="index">{{prop}}<i @click="removeProp">×</i></li>
          </ul>
        </div>
...
<script>
  ...
  export default {
    ...
    watch:{
      /* 
        watch监视回调默认调用的时机：收据由变化才调用
        如何实现初始化就调用一次 immediate:true
      */
     $route:{
       handler(){//参数变化
         this.updataParams()
