      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-if="options.keyword">{{options.keyword}}<i @click="remove(options.keyword)">×</i></li>
            <li class="with-x" v-if="options.categoryName">{{options.categoryName}}<i @click="remove(options.categoryName)">×</i></li>
           <!--  <li class="with-x" v-if="options.keyword">{{options.keyword}}<i @click="removeKeyword">×</i></li>
            ...
            <li class="with-x" v-if="this.options.trademark">{{this.options.trademark}}<i @click="removeTrademark">×</i></li>
            <li class="with-x" v-for="(prop,index) in options.props" :key="index">{{prop}}<i @click="removeProps">×</i></li>
